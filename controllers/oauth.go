...
func NewOAuth(os models.OAuthService, dbxconfig *oauth2.Config) *OAuth {
	return &OAuth{
		os:       os,
		dbxOAuth: dbxconfig,
	}
...
func (o *OAuth) DropboxConnect(w http.ResponseWriter, r *http.Request) {
	state := csrf.Token(r)
	cookie := http.Cookie{
		Name:     "oauth_state",
		Value:    state,
...
func (o *OAuth) DropboxCallback(w http.ResponseWriter, r *http.Request) {
	r.ParseForm()
	...
	oldToken, err := o.os.Find(user.ID, models.OAuthDropbox)
